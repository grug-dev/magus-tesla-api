...
6. **Run codegen**: `make css` then `make templ` (both Claude-authorized in this repo).
7. **Update docs in the SAME change** (required by `CLAUDE.md` "Docs track structural
