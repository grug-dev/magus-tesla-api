...
- `make ui-guard`, `make i18n-guard`, `make money-guard`, `make migration-guard` — the standalone guards
...
- **Test-Execution-Policy:** `Claude writes tests but never runs the suite — never go test
  ...
  ui-guard / make i18n-guard / make money-guard / make migration-guard. The owner runs the suite and reports
