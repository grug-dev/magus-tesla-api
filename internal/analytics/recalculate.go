...
func upsertVehicleMetricParamsFrom(row vehicleMetricRow) analyticsdb.UpsertVehicleMetricParams {
	return analyticsdb.UpsertVehicleMetricParams{
		...
		KmPerPctDeltaCalc:           pgFloat8FromPtr(row.KmPerPctDeltaCalc),
		...
		TpmsPressureFlPsi:           pgFloat8FromPtr(row.TpmsPressureFLPSI),
		TpmsPressureFrPsi:           pgFloat8FromPtr(row.TpmsPressureFRPSI),
		TpmsPressureRlPsi:           pgFloat8FromPtr(row.TpmsPressureRLPSI),
		TpmsPressureRrPsi:           pgFloat8FromPtr(row.TpmsPressureRRPSI),
		TpmsPressureFlPsiDeltaCalc:  pgFloat8FromPtr(row.TpmsPressureFLPSIDeltaCalc),
		TpmsPressureFrPsiDeltaCalc:  pgFloat8FromPtr(row.TpmsPressureFRPSIDeltaCalc),
		TpmsPressureRlPsiDeltaCalc:  pgFloat8FromPtr(row.TpmsPressureRLPSIDeltaCalc),
		TpmsPressureRrPsiDeltaCalc:  pgFloat8FromPtr(row.TpmsPressureRRPSIDeltaCalc),
	}
}
