...
| `internal/charging/db/query.sql` | sqlc source of truth: `CreateEntry`, `UpdateEntry` (`:one`, `WHERE id AND account_id`), `DeleteEntry`, list queries. |
