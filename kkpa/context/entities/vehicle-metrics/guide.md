...
The four TPMS (tire-pressure) columns (RM50): `tpms_pressure_fl_psi`, `tpms_pressure_fr_psi`,
...
`ChargeLimitSocPct`, `CapturedAt`, `MaxRangeChargeCounter` (RM38/MAG-47), and, as of RM50,
`TpmsPressureFLPSI`, `TpmsPressureFRPSI`, `TpmsPressureRLPSI`, `TpmsPressureRRPSI`,
`DistanceTraveledKmCalc`, `ConsumedPct`.
