...
| `[x]` | 3 | `RM52-platform-add-monthly-capacity-cli` | `platform` | `cmd/monthly-capacity`, the make target, docs and the KB | 1, 2 |
...
### Tier 3 — `[x]` `RM52-platform-add-monthly-capacity-cli` (module: `platform`, cross-cutting)
