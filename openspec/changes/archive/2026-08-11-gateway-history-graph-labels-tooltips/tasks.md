...
- [x] 5.3 Visually verify the 6/14/30-day presets render labels correctly (horizontal at 6, vertical at 14/30, no overlap, bar↔label aligned) using `make dev` against a vehicle with snapshot history.
